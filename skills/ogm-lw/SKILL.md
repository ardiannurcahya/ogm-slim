...
OGM-LW is a zero-latency, SQLite-backed operational memory service and AST codebase knowledge graph designed for AI coding agents.
...
- **Parameters**:
  ...
  - `metadata` *(object, optional)*: Context like `{"repository": "ogm-lw", "file": "src/cli.ts"}`.
